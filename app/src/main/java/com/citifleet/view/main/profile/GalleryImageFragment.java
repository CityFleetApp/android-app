...
public class GalleryImageFragment extends BaseFragment {
    ...
    void onDeleteBtnClick() {
        ...
        if (CitiFleetApp.getInstance().getNetworkManager().isConnectedOrConnecting()) {
            setLoading(true);
            Call<Void> call = CitiFleetApp.getInstance().getNetworkManager().getNetworkClient().deletePhoto(idToDelete);
