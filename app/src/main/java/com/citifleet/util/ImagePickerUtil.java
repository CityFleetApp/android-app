...
public class ImagePickerUtil {
    ...
    public ImagePickerUtil(Fragment fragment, List<? extends ImageView> images, String cameraImageName, ImageResultListener listener) {
    ...
    private File getFileForProfileFromCamera() {
        return new File(Environment.getExternalStorageDirectory() + File.separator + cameraImageName + "_" + positionToUpdateImage + ".png");
    }
